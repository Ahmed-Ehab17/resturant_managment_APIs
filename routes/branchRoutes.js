...
router.get("/ingredients",auth, allowedTo("operation manager"), branchControllers.ingredientList);
...
router.get("/sections/:branchId", auth, allowedTo("operation manager"), branchControllers.getSections);
router.get("/tables/:branchId/:stat", auth, allowedTo("branch manager", "assistant manager"), branchControllers.getTables);
...
router.get("/branchMenu/:branchId", auth, allowedTo("operation manager", "branch manager", "assistant manager"), branchControllers.getBranchMenu);
router.get("/branchLocation/:branchId", branchControllers.getBranchLocation);
router.get("/sectionOverview/:sectionId?/:daysInput?", auth, allowedTo("operation manager"), branchControllers.getSectionOverView);
