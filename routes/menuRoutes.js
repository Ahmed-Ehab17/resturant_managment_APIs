...
router.patch('/changeItemPicture', menuValidator.changeItemImage, menuControllers.changeItemPicture );
router.patch('/changeCategoryPicture', menuValidator.changeCategoryImage, menuControllers.changeCategoryPicture );
