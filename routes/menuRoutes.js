...
router.post('/itemRecommendations', menuControllers.getItemRecommendations);
router.post('/customerRecommendations', menuControllers.getCustomerItemRecommendations);
